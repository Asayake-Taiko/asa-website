...
<footer class='footer'>
  <div class='footer-top'>
    ...
    <div class='footer-sns'>
      <a aria-label="instagram" class='footer-sns-ig' target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/asayake_taiko/">
      ...
      <a aria-label="facebook" class='footer-sns-fb' target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/AsayakeTaiko/">
        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a aria-label="youtube" class='footer-sns-yt' target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/user/AsayakeTaiko/">
  ...
  <div class='footer-bottom'>
    <div class='flex items-center'>
      ...
      <span class='footer-copyright'>©2023 Asayake Taiko</span>
    </div>
