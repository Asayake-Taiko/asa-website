...
<header class='text-white z-[999] relative' class:backdrop-blur-md={page!=='home'}>
  ...
  <div class='flex items-center'>
    ...
    <nav class='hamburger-menu'>
      ...
      <button class='menu-button z-50 relative' class:text-black={page!=='home'} on:click={handleClick}>
      ...
      <div bind:this="{hamburgerNav}" class='absolute top-[-120vh] left-0 w-screen h-screen bg-asa-red rounded-bl-[300px] rounded-br-[300px] ease-out duration-1000 bg-opacity-95 overflow-y-auto'>
        ...
        <div class='sns flex items-center justify-end mx-auto my-4'>
          <a class='footer-sns-ig hamburgerLink' target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/asayake_taiko/" tabindex="-1">
          ...
          <a class='footer-sns-fb hamburgerLink' target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/AsayakeTaiko/" tabindex="-1">
            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a class='footer-sns-yt hamburgerLink' target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/user/AsayakeTaiko/" tabindex="-1">
